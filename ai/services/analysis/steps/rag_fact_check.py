...
6. 증거가 주장과 전혀 관련 없을 경우에만 NOT_ENOUGH_INFO로 판정합니다.
...
[판정 기준 (status)]
- SUPPORTED: 증거가 주장을 직접 지지함
- PARTIALLY_SUPPORTED: 주장의 일부는 맞으나 세부 내용이 다름
- REFUTED: 증거가 주장을 직접 반박함
- MISLEADING: 일부 사실은 있으나 광고 표현이 제도, 효능, 안전성을 과장하거나 오인하게 함
- UNSUPPORTED: 광고성 주장을 했지만 제공된 증거가 직접 뒷받침하지 않음
- NOT_ENOUGH_INFO: 관련 증거가 거의 없어서 지지/반박/과장 여부를 판단할 수 없음
