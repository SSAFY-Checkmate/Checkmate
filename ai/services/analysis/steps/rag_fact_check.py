...
8. [중요] explanation(설명) 작성 시, "첫 번째 출처", "문서 [1]"과 같이 모호하게 지칭하지 말고, 증거 텍스트에 포함된 실제 [출처 기관명] 또는 [URL]을 명확히 적어주세요. (예: "식품의약품안전처(mfds.go.kr)에 따르면...", "자체 검증 분석 결과에 따르면..."). 증거가 없는 경우에도 그 이유를 자세히 서술해야 합니다.
